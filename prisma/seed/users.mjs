...
const USERS = [
  {
    ...
    // Placeholder — a real Google OAuth access token is issued/refreshed on first login.
    access_token: process.env.SEED_ADMIN_ACCESS_TOKEN || 'seed-placeholder-access-token',
  },
  {
    ...
    // Placeholder — a real Google OAuth access token is issued/refreshed on first login.
    access_token: process.env.SEED_STAFF_ACCESS_TOKEN || 'seed-placeholder-access-token',
  },
];
